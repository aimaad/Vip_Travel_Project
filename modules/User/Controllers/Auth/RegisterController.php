	    ...
	    public function register(Request $request)
        {
            ...
            if ($validator->fails()) {
                ...
                $user = \App\User::create([
                    ...
                    'password'   => Hash::make($generatedPassword), // Utiliser le mot de passe généré
                ...
                Session::put('generated_password', $generatedPassword);
                Log::info('Generated password stored in session: ' . session('generated_password'));
