<form id="flight-offer-form" method="POST">
    ...
    <div class="card shadow-sm mb-4 border-0">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0">
                ✈️ {{ __("Recherche de Vol Multiple") }}
            </h4>
        </div>
        ...
        <div class="card-body">
            ...
            <!-- Vols multiples -->
            <h5 class="mb-3 border-bottom pb-2">🛫 {{ __("Vols") }}</h5>
            ...
            <h5 class="mb-3 border-bottom pb-2">🛬 {{ __("Vols Retour") }}</h5>
...
$('#add-return-flight-btn').click(function() {
    ...
    $('#flight-offer-form').on('submit', function(e) {
        ...
        $.ajax({
            url: "{{ route('flight.admin.offers.store') }}",
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    if (response.status === 'processing') {
        ...
        window.location.href = "{{ route('hotels.create') }}";
    }
