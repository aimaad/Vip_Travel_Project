...
<div class="card shadow-sm mb-4 border-0">
    ...
    <div class="card-body">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-6">
                <label class="form-label">{{ __("Numéro de vol retour") }}</label>
