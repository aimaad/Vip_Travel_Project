...
<div>
    <div class="booking-gallery-grid mb-2" style="overflow-x:auto;">
        @if($main)
            <img src="{{ $main }}" class="main-img shadow-sm"
                 alt="photo" data-bs-toggle="modal"
                 data-bs-target="#galleryModalCarousel"
                 data-img-index="0">
        @endif
        @if($topRight)
            <img src="{{ $topRight }}" class="top-right shadow-sm"
                 alt="photo" data-bs-toggle="modal"
                 data-bs-target="#galleryModalCarousel"
                 data-img-index="1">
        @endif
        @if($middleRight)
            <img src="{{ $middleRight }}" class="middle-right shadow-sm"
                 alt="photo" data-bs-toggle="modal"
                 data-bs-target="#galleryModalCarousel"
                 data-img-index="2">
        @endif
    ...
    <div class="booking-gallery-bottom" style="overflow-x:auto;">
        @foreach($bottom as $i => $img)
            @php $globalIndex = $i + 3; @endphp
            @if($i === 4 && $extraCount > 0)
                <div class="booking-gallery-plus"
                     data-bs-toggle="modal"
                     data-bs-target="#galleryModalCarousel"
                     data-img-index="{{ $globalIndex }}">
