(function ($){
    ...
    $(document).on('change','.bravo_form input[name=location_id], .bravo_form input[name=start], .bravo_form input[name=end], .bravo_form input[name=date], .bravo_form input[name=date]',function (){
        doSearch();
    });
