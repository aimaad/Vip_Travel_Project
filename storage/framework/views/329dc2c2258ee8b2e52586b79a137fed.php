                ...
                <?php else: ?>
                    <?php $__currentLoopData = $groupedFlights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $outboundKey => $flightGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="flight-group border-bottom p-4"
                             x-data="{
                                editing: false,
                                outbound: <?php echo \Illuminate\Support\Js::from([
                                ...
                                returnOptions: <?php echo \Illuminate\Support\Js::from(
...
toggleEdit() {
    ...
    this.editing = true;
                                ...
                                saveChanges() {
                                    fetch('<?php echo e(route('flights.updateDirectSingle')); ?>', {
                                        method: 'POST',
                                        headers: {
                                        ...
                                        body: JSON.stringify({
                                            flightId: '<?php echo e($outboundKey); ?>',
...
<?php /**PATH C:\angular\Vip_Travel_Project\resources\views/vendor/Flight/admin/offer/partials/amadeus_results_direct_single.blade.php ENDPATH**/ ?>