<form id="multi-offer-form" method="POST" action="<?php echo e(route('flight.admin.offers.store')); ?>">
    <?php echo csrf_field(); ?>
    ...
    <div class="card shadow-sm mb-4 border-0">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0">
                ✈️ <?php echo e(__("Create Multiple Offers with Multiple Flights")); ?>
...
<?php /**PATH C:\angular\Vip_travel\Vip_Travel_Project\resources\views/vendor/Flight/admin/offer/forms/multi_flight_multiple.blade.php ENDPATH**/ ?>