<div class="bravo_single_book_wrap <?php if(setting_item('tour_enable_inbox')): ?> has-vendor-box <?php endif; ?>">
    <div class="bravo_single_book">
        <div id="bravo_tour_book_app" v-cloak  data-tour-date="<?php echo e($tour_date); ?>" data-tour-date-html="<?php echo e(\Carbon\Carbon::parse($tour_date)->format('F j, Y')); ?>"> 
                    ...
                    <div class="form-group form-date-field form-date-search clearfix " data-format="<?php echo e(get_moment_date_format()); ?>">
                        ...
                        <div >
                            <div style="text-align: center;" >
                                <label><h4><?php echo e(__("Start Date")); ?></h4></label>
                                <div class="render check-in-render"><h5><?php echo e($tour_date); ?></h5></div>
                            </div>
...
<?php /**PATH C:\angular\Vip_travel\Vip_Travel_Project\themes/BC/Tour/Views/frontend/layouts/details/tour-form-book.blade.php ENDPATH**/ ?>