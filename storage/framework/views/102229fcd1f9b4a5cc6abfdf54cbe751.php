...
<?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="room-card-pro">
        ...
        <div class="type-title"><?php echo e(ucfirst($type)); ?></div>
        <?php if(isset($room['pension'])): ?>
            <div class="sub"><?php echo e($room['pension']); ?></div>
        <?php endif; ?>
        <div class="badges">
            <span class="badge bg-primary-subtle text-primary">
                <i class="fa-solid fa-user"></i>
                <?php echo e($room['adults'] ?? '-'); ?> Adulte<?php echo e(($room['adults'] ?? 0) > 1 ? 's' : ''); ?>

            </span>
            <?php if(!empty($room['children'])): ?>
            <span class="badge bg-warning-subtle text-warning">
                <i class="fa-solid fa-child"></i>
                <?php echo e($room['children']); ?> Enfant<?php echo e($room['children'] > 1 ? 's' : ''); ?>

            </span>
            <?php endif; ?>
            <?php if(!empty($room['babies'])): ?>
            <span class="badge bg-success-subtle text-success">
                <i class="fa-solid fa-baby"></i>
                <?php echo e($room['babies']); ?> Bébé<?php echo e($room['babies'] > 1 ? 's' : ''); ?>
...
</div><?php /**PATH C:\angular\Vip_travel\Vip_Travel_Project\resources\views/offres/partials/_room_types.blade.php ENDPATH**/ ?>